...
class Command(BaseCommand):
    ...
    def handle(self, name, **options):
        ...
        if engine == 'django.db.backends.postgresql_psycopg2':
            ...
            return self.drop_postgresql_psycopg2(name, username=username, hostname=hostname, port=port)
        elif engine == 'django.db.backends.sqlite3':
            return self.drop_sqlite3(name)
...
#            return self.create_oracle(name)
    ...
    def drop_postgresql_psycopg2(self, name, username=None, hostname=None, port=5432):
        cmd = ['dropdb']
    ...
    def drop_sqlite3(self, name):
        self.run_command(['rm', name])
    
    def drop_postgresql(self, name):
        raise NotImplementedError
    
    def drop_mysql(self, name):
        raise NotImplementedError
    
    def drop_oracle(self, name):
        raise NotImplementedError
